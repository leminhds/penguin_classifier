...
new_prediction = rfc.predict([[bill_length, bill_depth, flipper_length, body_mass,
                               ...
                               sex_female, sex_male]])
prediction_of_specie = unique_penguin_mapping[new_prediction][0]

st.write('the user input are {}'.format([sex, island, bill_depth, flipper_length, body_mass]))
st.subheader("Predicting Your Penguin's Species:")
st.write('We predict your penguin is of the {} species'.format(prediction_of_specie))
